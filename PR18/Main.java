...
class ThreeParams<T extends Comparable<T>, V extends Serializable, K> {
    ...
    public void printClassNames() {
        System.out.println("T: " + t.getClass().getName() + " " + getT());
        System.out.println("V: " + v.getClass().getName() + " " + getV());
        System.out.println("K: " + k.getClass().getName() + " "+ getK());
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nElement at (2, 2): " + matrix.getElement(1, 1));
    }
}